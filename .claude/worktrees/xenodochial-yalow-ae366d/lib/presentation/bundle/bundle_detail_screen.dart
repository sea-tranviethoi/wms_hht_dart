  ...
  Widget build(BuildContext context) {
    if (_lines.isEmpty) {
      return Scaffold(
        ...
        body: AppEmpty.list(message: '明細データがありません'),
      );
    }

    if (_isSyncing) {
      return Scaffold(
        body: AppLoading.centered(message: '同期中...'),
      );
    }
        ...
        children: [
          ...
          Container(
            ...
            decoration: BoxDecoration(
              color: AppColors.settingsColor4.withValues(alpha: 0.08),
              border: Border(
                bottom: BorderSide(
                  color: AppColors.settingsColor4.withValues(alpha: 0.25),
                ),
              ),
            ),
            child: Row(
        ...
        TextField(
          ...
          decoration: InputDecoration(
            ...
            focusedBorder: OutlineInputBorder(
              borderSide:
                  BorderSide(color: AppColors.settingsColor4, width: 1.5),
            ),
          ),
