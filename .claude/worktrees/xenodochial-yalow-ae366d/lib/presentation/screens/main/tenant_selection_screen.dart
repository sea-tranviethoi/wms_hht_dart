...
class _TenantSelectionViewState extends State<_TenantSelectionView> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        backgroundColor: widget.funcNumber == '3'
            ? AppColors.settingsColor3 // ピッキング (Orange)
            : AppColors.settingsColor1, // 入荷 (Blue) — default
          ...
          child: Container(
            ...
            child: Text(
              ...
              style: const TextStyle(
                ...
                fontWeight: FontWeight.bold,
                shadows: [
                  Shadow(color: AppColors.shadowLight, offset: Offset(1, 1), blurRadius: 2),
                ],
              ),
              textAlign: TextAlign.center,
            ),
